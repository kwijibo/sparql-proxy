...
class:    Talis_ChangeSetBuilderPlugin
author:   Keith Alexander
version:  2008-10-13

notes:  val is now value, and uri is  uri


added more commentary

made sure not to try to parse an empty string, which cause arc to try to parse the calling script uri

made sure not to create empty changesets

*/

ARC2::inc('Class');

class Talis_ChangeSetBuilderPlugin extends ARC2_Class {
	  ...
	  function Talis_ChangeSetBuilderPlugin ($a = '', &$caller) {
